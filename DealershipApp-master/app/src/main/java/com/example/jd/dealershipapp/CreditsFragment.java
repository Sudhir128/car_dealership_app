...
public class CreditsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String meetTheTeamAuthor = "Toyota Camry";
        ...
        creditList.add(new Credits("Toyota Camry", meetTheTeamAuthor, meetTheTeamPicOneDesc, "https://pixabay.com/en/attractive-beautiful-girl-model-1869761/"));
        creditList.add(new Credits("Honda Civic", meetTheTeamAuthor, meetTheTeamPicTwoDesc, "https://pixabay.com/en/beard-face-man-model-mustache-1845166/"));
        creditList.add(new Credits("Ford F-150", meetTheTeamAuthor, meetTheTeamPicThreeDesc, "https://pixabay.com/en/beautiful-fashion-grass-model-1844724/"));

        creditList.add(new Credits("Chevrolet Malibu", jeepAuthor, jeepPicOneDesc, "https://pixabay.com/en/vehicle-car-wheel-jeep-luxury-suv-3196981/"));
        creditList.add(new Credits("Nissan Altima", jeepAuthor, jeepPicTwoDesc, "https://pixabay.com/en/vehicle-car-transportation-system-3206929/"));
        creditList.add(new Credits("BMW 3 Series", jeepAuthor, jeepPicThreeDesc, "https://pixabay.com/en/tire-track-sand-tread-imprint-2211379/"));
